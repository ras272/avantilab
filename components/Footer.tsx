      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid md:grid-cols-12 gap-8 mb-12">
          ...
          <div className="md:col-span-2 md:col-start-6">
            <span className="text-[#c81e1e] font-sans text-xs uppercase tracking-wider block mb-4">
              Nav
            </span>
          ...
          <div className="md:col-span-2">
            ...
            <nav className="flex flex-col gap-3">
              <a
                ...
                className="text-white/60 font-sans text-sm hover:text-[#c81e1e] transition-colors flex items-center gap-2"
              >
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="text-white/30 font-sans text-xs">
            © 2026 Avanti Lab. Todos los derechos reservados.
          </span>
          <button
